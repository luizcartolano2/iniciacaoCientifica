...
class HTML_Page(object):
	...
	def print_html(self, path, name, title, polyline, lat_init, lng_init, lat_fim, lng_fim, distance, time_of_trip, timestamp, traffic, duration, dist):
		                    ...
		                    <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
		                        <div class="gm-style" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;">
		                            ...
		                            <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
		                                <a target="_blank" href="https://maps.google.com/maps?ll=-25.470201,-49.198536&amp;z=11&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3" title="Click to see this area on Google Maps" style="position: static; overflow: visible; float: none; display: inline;">
		                                    <div style="width: 66px; height: 26px; cursor: pointer;"><img alt="" src="http://maps.gstatic.com/mapfiles/api-3/images/google4_hdpi.png" draggable="false" style="position: absolute; left: 0px; top: 0px; width: 66px; height: 26px; -webkit-user-select: none; border: 0px; padding: 0px; margin: 0px;"></div>
		                                </a>
		                            </div>
		...
		f.write(""" </p>
					...
					<hr> """)
		# timestamp = "14/02/98"
		f.write(""" <h5 align="LEFT"> GMT Time: """ + timestamp + "</h5")
		f.write("<br></br>")
		# traffic = 63
		f.write(""" <h5 align="LEFT"> Duration in traffic (s): """ + str(traffic) + "</h5")
		f.write("<br></br>")
		# duration = 10
		f.write(""" <h5 align="LEFT"> Pessimistic duration in traffic (s): """ + str(duration) + "</h5")
		f.write("<br></br>")
		# dist = 10
